...
namespace Questao5.Infrastructure.Sqlite
{
    public class DatabaseBootstrap : IDatabaseBootstrap
    {
        ...
        public void Setup()
        {
            ...
            connection.Execute("INSERT INTO movimento(idmovimento, idcontacorrente, datamovimento, tipomovimento, valor) VALUES('D2E02051-7067-ED11-94C0-835DFA4A16C1','D2E02051-7067-ED11-94C0-835DFA4A16C9', '2024-04-01', 'C', 10);");
            connection.Execute("INSERT INTO movimento(idmovimento, idcontacorrente, datamovimento, tipomovimento, valor) VALUES('D2E02051-7067-ED11-94C0-835DFA4A16C2','D2E02051-7067-ED11-94C0-835DFA4A16C9', '2024-04-02', 'C', 20);");
            connection.Execute("INSERT INTO movimento(idmovimento, idcontacorrente, datamovimento, tipomovimento, valor) VALUES('D2E02051-7067-ED11-94C0-835DFA4A16C3','D2E02051-7067-ED11-94C0-835DFA4A16C9', '2024-04-03', 'C', 30);");
            connection.Execute("INSERT INTO movimento(idmovimento, idcontacorrente, datamovimento, tipomovimento, valor) VALUES('D2E02051-7067-ED11-94C0-835DFA4A16C4','D2E02051-7067-ED11-94C0-835DFA4A16C9', '2024-04-04', 'C', 40);");
            connection.Execute("INSERT INTO movimento(idmovimento, idcontacorrente, datamovimento, tipomovimento, valor) VALUES('D2E02051-7067-ED11-94C0-835DFA4A16C5','D2E02051-7067-ED11-94C0-835DFA4A16C9', '2024-04-05', 'C', 50);");
        }
    }
}
